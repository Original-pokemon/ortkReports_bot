module.exports = function adminRoute(
  botInstance,
  router,
  mainService,
  panelService,
  ...
  botInstance.callbackQuery(
    /ban_([0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12})$/,
    banService
  )
  botInstance.callbackQuery(
    /promote_([0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12})$/,
    promoteService
  )
}
