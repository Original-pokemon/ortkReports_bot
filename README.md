# Инструкция по настойке и запуску бота

Для настройки бота существуют файлы config.txt и .env  
В config.txt есть переменные к примеру MAIN_PATH=D:\bot\  
...
MAIN_PATH - это название переменной, то что идет после равно - значение переменной

```
MAIN_PATH = //путь к файлу
